...
const Footer = () => {
  return (
    <>
        ...
        <div className="footer container border-b mx-auto px-4 p-10 text-neutral-content">
          <div className='max-w-md'>
            <Link
              to="/"
              className="
          font-bold md:text-3xl text-2xl
          bg-gradient-to-r from-green-600 to-indigo-300  text-transparent bg-clip-text
          "
            >
              GreenVilla
            </Link>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur voluptates architecto cum </p>
      ...
      <footer className="  bg-neutral ">
        <div className="footer container mx-auto px-4 items-center p-4 text-neutral-content">
